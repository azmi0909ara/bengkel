...
const menu = [
  ...
  {
    label: "Estimasi", // <<< Tambahan menu Estimasi
    href: "/estimasi",
    icon: TrendingUpDown, // Bisa pakai icon lain jika mau
  },
  {
    label: "Service",
    href: "/service",
  ...
  return (
    <aside className="w-64 min-h-screen bg-gradient-to-b from-gray-900 via-gray-900 to-black text-white border-r border-gray-800 flex flex-col">
      ...
      <div className="px-6 py-8 border-b border-gray-800">
        ...
        <p className="text-xs text-gray-400 mt-1">Automotive Admin System</p>
      </div>
