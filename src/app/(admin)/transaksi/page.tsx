              ...
              <td colSpan={6} className="p-12 text-center">
                <div className="flex flex-col items-center gap-3 text-gray-400">
                  ...
                  <p className="text-sm text-gray-500">
                    Transaksi servis akan muncul di sini
                  </p>
                </div>
              </td>
            </tr>
                ...
                <td className="p-2">
                  <span
                    className={`px-2 py-1 rounded text-xs ${
                      s.status === "SELESAI" ? "bg-green-600" : "bg-yellow-600"
                    }`}
                  >
                    {s.status}
                  </span>
          ...
          <div className="bg-gray-900 w-full max-w-3xl rounded-xl p-6 max-h-[90vh] overflow-y-auto">
            ...
            <table className="w-full text-sm border border-gray-700 mb-4">
              <tbody>
                ...
                <tr>
                  <td className="p-2 border">No HP 1</td>
                  <td className="p-2 border">{p?.noHp1}</td>
                </tr>
                <tr>
                  <td className="p-2 border">No HP 2</td>
                  <td className="p-2 border">{p?.noHp2}</td>
                </tr>
                <tr>
                  <td className="p-2 border">NIK</td>
                  <td className="p-2 border">{p?.nik}</td>
                </tr>
                <tr>
                  <td className="p-2 border">Tanggal Lahir</td>
                ...
                <tr>
                  <td className="p-2 border">Alamat</td>
                  <td className="p-2 border">{p?.alamat1}</td>
                </tr>
                <tr>
                  <td className="p-2 border">Alamat 2</td>
                  <td className="p-2 border">{p?.alamat2}</td>
                </tr>
              </tbody>
            </table>
            ...
            <table className="w-full text-sm border border-gray-700 mb-4">
              <tbody>
                <tr>
                  <td className="p-2 border">Nomor Polisi</td>
                  <td className="p-2 border">{k?.nomorPolisi}</td>
                </tr>
                <tr>
                  <td className="p-2 border">Merek / Tipe</td>
                  <td className="p-2 border">
                    {k?.merek} {k?.tipe}
                  </td>
                </tr>
                <tr>
                  <td className="p-2 border">Warna</td>
                  <td className="p-2 border">{k?.warna}</td>
                </tr>
                <tr>
                  <td className="p-2 border">Tahun</td>
                  <td className="p-2 border">{k?.tahunProduksi}</td>
                </tr>
                <tr>
                  <td className="p-2 border">KM Masuk</td>
                  <td className="p-2 border">{detail.kmSekarang}</td>
                </tr>
              </tbody>
            </table>
            ...
            <table className="w-full text-sm border border-gray-700 mb-4">
              <tbody>
                <tr>
                  <td className="p-2 border">Tanggal</td>
                  <td className="p-2 border">
                    {detail.tanggal?.toDate().toLocaleDateString("id-ID")}
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td className="p-2 border">{detail.keluhan}</td>
                </tr>
                <tr>
                  <td className="p-2 border">Status Kendaraan</td>
                  <td className="p-2 border">{detail.statusKendaraan}</td>
                </tr>
                <tr>
                  <td className="p-2 border">Pembayaran</td>
                  <td className="p-2 border">{detail.jenisPembayaran}</td>
                </tr>
                <tr>
