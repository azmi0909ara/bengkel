  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white p-6">
      ...
      <form
        ...
        ref={formRef}
        className="bg-gray-900 border border-gray-700 rounded-xl p-6 mb-10"
      >
            ...
            {filteredData.map((item) => (
              ...
              >
                ...
                <td className="p-3">
                  {item.noHp1}
                  {item.noHp2 && (
                    <div className="text-sm text-gray-400">{item.noHp2}</div>
                  )}
                </td>
        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50">
          <div className="bg-gray-900 border border-gray-700 rounded-xl p-6 max-w-2xl w-full">
            ...
            <div className="grid grid-cols-2 gap-3 text-sm">
              ...
              <p>
                <b>HP 1:</b> {detail.noHp1}
              </p>
              <p>
                <b>HP 2:</b> {detail.noHp2}
              </p>
              <p>
                <b>Gender:</b> {detail.gender}
              </p>
              <p>
                <b>Birthdate:</b> {detail.birthdate}
              </p>
              <p>
                <b>Email:</b> {detail.email}
              </p>
              <p>
                <b>Kode Pos:</b> {detail.kodePos}
              </p>
              <p>
                <b>Kota:</b> {detail.ibuKota}
              </p>
              <p className="col-span-2">
                <b>Alamat 1:</b> {detail.alamat1}
              </p>
              <p className="col-span-2">
                <b>Alamat 2:</b> {detail.alamat2}
              </p>
              <p className="col-span-2">
